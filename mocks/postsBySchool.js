const  { getRandomIntFromInterval } = require('../utils/getRandomFromInterval');

module.exports = [
    {
        id: '1',
        count: getRandomIntFromInterval(0, 300),
    ...
    },
    {
        id: '7',
        count: getRandomIntFromInterval(0, 300),
        name: 'Sam Houston Middle School',
    },
    {
        id: '8',
        count: getRandomIntFromInterval(0, 300),
